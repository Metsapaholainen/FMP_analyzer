...
def _build_prompt(snapshot: dict, moat: dict, valuation: dict, red_flags: list,
    ...
    return (
        ...
        "If pe_ratio_ttm is very high (>40×) for a cyclical or transition company, "
        "this ALWAYS reflects trough GAAP earnings — do NOT interpret a 50-80× P/E as 'very expensive'; "
        "instead note that trough P/E is uninformative and pivot to EV/EBITDA, FCF yield, "
        "or the ROIC-recovery framing described in the Industry Cycle Context above.\n"
        f"{transition_block}"
        f"{hypothesis_block}\n\n"
